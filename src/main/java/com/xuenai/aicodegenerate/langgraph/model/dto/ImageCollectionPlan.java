package com.xuenai.aicodegenerate.langgraph.model.dto;
...
public class ImageCollectionPlan implements Serializable {
     ...
     */
    public record ImageSearchTask(String queryZh,String queryEn) implements Serializable {
    }
     ...
     */
    public record IllustrationTask(String queryZh,String queryEn) implements Serializable {
    }
